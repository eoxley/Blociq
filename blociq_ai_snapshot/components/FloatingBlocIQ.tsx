...
import { MessageCircle, X, Send, Loader2, Minimize2, Maximize2, Paperclip, Home, Move, Resize } from 'lucide-react'
    ...
    <div className="fixed bottom-6 right-6 z-50">
      ...
      {isOpen && (
        ...
        >
          {/* Header */}
          <div 
            className="bg-gradient-to-r from-teal-600 to-teal-700 text-white p-4 rounded-t-3xl flex items-center justify-between cursor-grab active:cursor-grabbing"
              ...
              <form onSubmit={handleSubmit} className="p-4 border-t border-gray-200/50 bg-white/50 backdrop-blur-sm rounded-b-3xl">
                ...
                <div className="flex gap-2">
                  ...
                  <input
                    ...
                    className="flex-1 px-4 py-3 border border-gray-300/50 rounded-xl focus:outline-none focus:ring-2 focus:ring-teal-500 focus:border-transparent bg-white/80 backdrop-blur-sm text-sm"
                    disabled={isLoading}
                  />
                  <button 
                    type="submit"
