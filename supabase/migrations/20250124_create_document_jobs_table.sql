...
-- This table stores document processing jobs without requiring building associations
...
CREATE TABLE IF NOT EXISTS public.document_jobs (
  ...
  CONSTRAINT document_jobs_agency_id_fkey FOREIGN KEY (agency_id) REFERENCES public.agencies(id) ON DELETE SET NULL
);
