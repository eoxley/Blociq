-- Comprehensive Compliance Asset Schema for Supabase
-- Migration: 20250123_comprehensive_compliance_schema.sql
...
INSERT INTO compliance_templates (asset_type, asset_name, category, description, default_frequency, default_frequency_months, is_required_by_default, is_hrb_only) VALUES
-- Fire Safety
('fire_alarm_system', 'Fire Alarm System', 'fire_safety', 'Annual inspection and testing of fire alarm system', 'annual', 12, true, false),
('emergency_lighting', 'Emergency Lighting', 'fire_safety', 'Monthly testing of emergency lighting systems', 'monthly', 1, true, false),
('fire_extinguishers', 'Fire Extinguishers', 'fire_safety', 'Annual service and inspection of fire extinguishers', 'annual', 12, true, false),
('fire_door_inspection', 'Fire Door Inspection', 'fire_safety', 'Annual inspection of fire doors and seals', 'annual', 12, true, false),
('sprinkler_system', 'Sprinkler System', 'fire_safety', 'Annual inspection and testing of sprinkler system', 'annual', 12, true, false),

-- Electrical
('electrical_installation', 'Electrical Installation Condition Report (EICR)', 'electrical', 'Comprehensive electrical safety inspection', 'quinquennial', 60, true, false),
('portable_appliance_testing', 'Portable Appliance Testing (PAT)', 'electrical', 'Testing of portable electrical appliances', 'annual', 12, false, false),
('emergency_generator', 'Emergency Generator', 'electrical', 'Monthly testing of emergency generator', 'monthly', 1, true, false),

-- Gas Safety
('gas_safety_check', 'Gas Safety Check', 'gas', 'Annual gas appliance safety inspection', 'annual', 12, true, false),
('boiler_service', 'Boiler Service', 'gas', 'Annual boiler service and maintenance', 'annual', 12, true, false),
('gas_pipework', 'Gas Pipework Inspection', 'gas', 'Annual inspection of gas pipework', 'annual', 12, true, false),

-- Structural
('structural_survey', 'Structural Survey', 'structural', 'Comprehensive structural condition assessment', 'quinquennial', 60, false, false),
('facade_inspection', 'Facade Inspection', 'structural', 'External building facade safety inspection', 'annual', 12, false, false),
('roof_inspection', 'Roof Inspection', 'structural', 'Annual roof condition inspection', 'annual', 12, false, false),
('lift_maintenance', 'Lift Maintenance', 'structural', 'Monthly lift maintenance and inspection', 'monthly', 1, true, false),

-- Environmental
('asbestos_survey', 'Asbestos Management Survey', 'environmental', 'Asbestos presence and condition assessment', 'triennial', 36, false, false),
('legionella_risk_assessment', 'Legionella Risk Assessment', 'environmental', 'Water system legionella risk evaluation', 'biennial', 24, true, false),
('water_system', 'Water System Risk Assessment', 'environmental', 'Annual water system risk assessment', 'annual', 12, true, false),
('air_quality', 'Air Quality Assessment', 'environmental', 'Annual air quality monitoring', 'annual', 12, false, false),

-- Building Safety Act (HRB Only)
('building_safety_case', 'Building Safety Case', 'building_safety', 'Comprehensive building safety case for HRB', 'ongoing', NULL, false, true),
('golden_thread', 'Golden Thread Documentation', 'building_safety', 'Maintenance of golden thread information', 'ongoing', NULL, false, true),
('safety_case_report', 'Safety Case Report', 'building_safety', 'Annual safety case report for HRB', 'annual', 12, false, true),
('mandatory_reporting', 'Mandatory Occurrence Reporting', 'building_safety', 'Ongoing mandatory occurrence reporting', 'ongoing', NULL, false, true),

-- Health & Safety
('health_safety_audit', 'Health & Safety Audit', 'health_safety', 'Annual health and safety audit', 'annual', 12, true, false),
('risk_assessment', 'Risk Assessment', 'health_safety', 'Annual risk assessment review', 'annual', 12, true, false),
('first_aid', 'First Aid Provision', 'health_safety', 'Annual review of first aid provision', 'annual', 12, true, false)
