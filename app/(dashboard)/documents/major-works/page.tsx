...
export default function MajorWorksLabPage() {
  return (
    <div className="space-y-8">
      {/* Hero Banner */}
      <section className="relative overflow-hidden bg-gradient-to-r from-orange-600 via-red-600 to-orange-700 py-16 mx-6 rounded-2xl">
          ...
          <div className="text-center">
            <div className="flex justify-center mb-6">
              <div className="p-5 rounded-2xl bg-white/20 backdrop-blur-md border border-white/30 shadow-xl">
                <Wrench className="h-14 w-14 text-white drop-shadow-lg" />
              </div>
            </div>
            ...
            <p className="text-xl text-white/90 max-w-3xl mx-auto leading-relaxed">
              Upload contracts, specifications, and project documentation for intelligent analysis and tracking
            </p>
          </div>
        </div>
        ...
        <div className="absolute top-0 left-0 w-full h-full overflow-hidden pointer-events-none">
          ...
          <div className="absolute top-1/2 right-1/4 w-24 h-24 bg-orange-400/20 rounded-full blur-2xl"></div>
        </div>
      </section>
