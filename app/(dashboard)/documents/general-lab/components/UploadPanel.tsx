...
export default function UploadPanel({ onUploadSuccess }: UploadPanelProps) {
  ...
  const handleFileUpload = async (file: File) => {
    ...
    try {
      ...
      const response = await fetch('/api/general-lab/upload', {
        method: 'POST',
        body: formData,
      });
  ...
  return (
    <div className="bg-white rounded-2xl shadow-sm border border-gray-200 p-8">
      <div className="text-center mb-6">
        <h2 className="text-2xl font-semibold text-gray-900 mb-2">Upload General Documents</h2>
        <p className="text-gray-600">Property management documents, contracts, correspondence, reports, and other business documents</p>
      </div>
      ...
      <div className="mt-6 bg-gray-50 rounded-lg p-4">
        ...
        <ul className="text-sm text-gray-600 space-y-1">
          <li>• Contracts: Include all pages and appendices</li>
          <li>• Reports: Ensure tables and charts are clearly visible</li>
          <li>• Correspondence: Upload complete email chains or letter sequences</li>
