  ...
  const saveSelections = async () => {
    ...
    try {
      ...
      if (unselectedAssetIds.length > 0) {
        ...
        if (deleteError) {
          throw new Error(`Failed to remove unselected assets: ${deleteError.message}`)
        }
      }
        ...
        <BlocIQCardContent>
          <div className="text-center py-6">
            ...
            <p className="text-[#64748B] mb-6">
              {saveStatus === 'success' 
                ? 'Your selections have been saved successfully! You can now proceed to the compliance tracker.'
                : 'Your selections will be saved and you can proceed to the compliance dashboard.'
              }
            </p>
            <div className="space-y-3">
              {saveStatus !== 'success' && (
