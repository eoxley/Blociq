...
export async function GET(req: NextRequest) {
  try {
    ...
    console.log('✅ User authenticated for major works lab jobs');
    ...
    console.log('🔍 Querying major works jobs for user_id:', user.id);
    ...
    console.log(`📋 Found ${jobs?.length || 0} major works jobs for user`);
    ...
    console.error('Unexpected error in major works jobs:', error);
    return NextResponse.json({
