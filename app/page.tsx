        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            <div className="group text-center">
              ...
              <div className="text-3xl font-bold text-teal-700 group-hover:scale-110 transition-transform duration-300">500+</div>
              <div className="text-sm text-gray-600 font-medium">Properties Managed</div>
            </div>
            <div className="group text-center">
              ...
              <div className="text-3xl font-bold text-blue-700 group-hover:scale-110 transition-transform duration-300">99.8%</div>
            ...
            <div className="group text-center">
              ...
              <div className="text-3xl font-bold text-green-700 group-hover:scale-110 transition-transform duration-300">50K+</div>
              <div className="text-sm text-gray-600 font-medium">Emails Processed</div>
            </div>
            <div className="group text-center">
              ...
              <div className="text-3xl font-bold text-purple-700 group-hover:scale-110 transition-transform duration-300">24/7</div>
              <div className="text-sm text-gray-600 font-medium">AI Assistance</div>
            </div>
          </div>
        </div>
      </section>
          ...
          <div className="bg-gradient-to-br from-white to-gray-50 rounded-2xl p-10 shadow-xl border border-gray-100 mb-12">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              ...
              <div className="flex items-start gap-4 p-6 bg-white/50 rounded-xl hover:bg-white/70 transition-colors">
                ...
                <div>
                  <h3 className="font-semibold text-gray-900 mb-2 text-lg">Enterprise security</h3>
                  <p className="text-gray-600">Bank-grade security with SOC 2 compliance and regular audits.</p>
                </div>
              </div>
            </div>
          </div>
