    ...
    <aside className="w-72 bg-white text-[#333333] h-full flex flex-col py-6 px-4 shadow-xl border-r border-[#E2E8F0] relative overflow-hidden">
        ...
        {navItems.map(({ label, icon, href, comingSoon, description }) => {
          ...
          if (comingSoon) {
            return (
              <div key={label} className="w-full group">
                <button
                  className="flex w-full items-center gap-3 rounded-xl px-4 py-3 text-sm font-medium text-[#64748B] hover:bg-[#F0FDFA] transition-all relative group"
                  disabled
                >
                  <div className="w-10 h-10 rounded-xl flex items-center justify-center transition-all duration-300 bg-[#F3F4F6] group-hover:bg-[#E2E8F0] relative">
                    <span
                  ...
                  <div className="flex-1 text-left">
                    <div className="flex items-center gap-2">
                      ...
                      <BlocIQBadge variant="secondary" size="sm" className="text-xs">Coming Soon</BlocIQBadge>
                    </div>
          ...
          return (
            <div key={label} className="w-full group">
              <Link
                href={href}
                className={`flex items-center gap-3 rounded-xl px-4 py-3 text-sm font-medium transition-all duration-300 relative group ${
                  isActive
      ...
      <div className="border-t border-[#E2E8F0] pt-4 mb-4">
        ...
        <div className="space-y-2">
          <Link
            href="/inbox"
            className="flex items-center gap-3 px-4 py-2 rounded-lg text-sm font-medium hover:bg-[#F0FDFA] transition-all duration-300 group text-[#333333]"
          >
            <div className="w-8 h-8 bg-blue-100 rounded-lg flex items-center justify-center group-hover:bg-blue-200 transition-all duration-300 relative">
          ...
          <Link
            ...
            className="flex items-center gap-3 px-4 py-2 rounded-lg text-sm font-medium hover:bg-[#F0FDFA] transition-all duration-300 group text-[#333333]"
          >
            <div className="w-8 h-8 bg-purple-100 rounded-lg flex items-center justify-center group-hover:bg-purple-200 transition-all duration-300">
          ...
          <Link
            ...
            className="flex items-center gap-3 px-4 py-2 rounded-lg text-sm font-medium hover:bg-[#F0FDFA] transition-all duration-300 group text-[#333333]"
          >
            <div className="w-8 h-8 bg-green-100 rounded-lg flex items-center justify-center group-hover:bg-green-200 transition-all duration-300">
      ...
      <div className="border-t border-[#E2E8F0] pt-4">
        <div className="space-y-2">
          ...
          <button
            ...
            className="flex items-center gap-3 px-4 py-2 rounded-lg text-sm font-medium hover:bg-red-50 transition-all duration-300 w-full text-left group text-[#EF4444]"
          >
