...
interface DocumentUploadModalProps {
  ...
  documentCategory: 'major-works' | 'general' | 'compliance'
  maxFiles?: number
...
const DocumentUploadModal: React.FC<DocumentUploadModalProps> = ({
  ...
  documentCategory,
  maxFiles = 10,
  acceptedFileTypes = ['.pdf', '.jpg', '.jpeg', '.png', '.doc', '.docx', '.xlsx', '.csv'],
  ...
  const categoryConfig = {
    'major-works': {
      title: 'Major Works Documents',
      description: 'Upload project documentation, contracts, and construction-related documents with AI analysis',
      icon: Wrench,
      color: 'orange',
      types: [
        'Contract',
    ...
    'general': {
      ...
      description: 'Upload meeting minutes, correspondence, notices, and other general documentation',
      icon: FileText,
      color: 'gray',
      types: [
        'Meeting Minutes',
    ...
    'compliance': {
      ...
      description: 'Upload compliance documents with AI-powered analysis and classification',
      icon: Shield,
      color: 'blue',
      types: [
        'EICR Certificate',
  ...
  const config = categoryConfig[documentCategory]
  ...
  const onDrop = useCallback((acceptedFiles: File[], rejectedFiles: any[]) => {
    ...
    const newFiles: UploadFile[] = acceptedFiles.map(file => ({
      ...
      progress: 0,
      status: 'pending',
      documentType: config.types[0] // Default to first type
    }))

    setUploadFiles(prev => [...prev, ...newFiles])
  }, [maxFiles, maxFileSize, acceptedFileTypes, config.types])
  ...
  const uploadSingleFile = async (uploadFile: UploadFile) => {
    try {
      ...
      // Add document type hint for better classification
      ...
      return new Promise<any>((resolve, reject) => {
        ...
        // Use the upload-and-analyse endpoint for OCR processing
          ...
          >
            ...
            <div className="flex flex-col items-center gap-4">
              <div className="p-3 bg-white rounded-full shadow-sm">
                <Upload className={`h-8 w-8 ${isDragActive ? colorClasses.text : 'text-gray-400'}`} />
              </div>

              <div>
                <p className="text-lg font-medium text-gray-900 mb-1">
                  {isDragActive ? 'Drop documents here' : `Upload ${config.title}`}
                </p>
                      ...
                      <div className="flex items-center gap-2 mb-2">
                        ...
                        <div className="flex items-center gap-2 flex-1">
                          <select
                            ...
                            onChange={(e) => updateFileProperty(uploadFile.id, 'documentType', e.target.value)}
                            className="text-xs border border-gray-300 rounded px-2 py-1 flex-1"
                            disabled={uploadFile.status !== 'pending'}
                          >
          ...
          <div className="flex items-center justify-between pt-4 border-t">
            ...
            <div className="flex items-center gap-3">
              ...
              <button
                ...
                className={`px-6 py-2 text-white rounded-lg transition-colors disabled:opacity-50 disabled:cursor-not-allowed flex items-center gap-2 ${colorClasses.button}`}
              >
                {isUploading ? (
                  <>
